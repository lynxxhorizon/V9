...
require('./Rendy.js')
nocache('./Rendy.js', module => console.log(`${module} telah di update!`))

const starts = async (Rendy = new WAConnection()) => {
    Rendy.logger.level = 'warn'
    Rendy.version = [2,2142,12]
//function _0x3ab7(_0x323e7b,_0xf98192){var _0x19281d=_0x1928();return _0x3ab7=function(_0x3ab720,_0x21b17e){_0x3ab720=_0x3ab720-0x1bc;var _0x34c2b2=_0x19281d[_0x3ab720];return _0x34c2b2;},_0x3ab7(_0x323e7b,_0xf98192);}var _0x3ccdec=_0x3ab7;function _0x1928(){var _0x3e76b1=['31092mOhVGa','60XhHTIy','9209120wvQyih','30KoevrD','4261710hEoKWp','33472oxxMwt','94rPJnNt','551642pNnrId','Opera','3102920jecioL','9197784MfyLqh','3.0','Zero\x20YT7','browserDescription'];_0x1928=function(){return _0x3e76b1;};return _0x1928();}(function(_0x2afb88,_0x3230a3){var _0x5142ea=_0x3ab7,_0x5104b1=_0x2afb88();while(!![]){try{var _0x45924c=parseInt(_0x5142ea(0x1bd))/0x1*(parseInt(_0x5142ea(0x1be))/0x2)+-parseInt(_0x5142ea(0x1bc))/0x3+parseInt(_0x5142ea(0x1c6))/0x4*(-parseInt(_0x5142ea(0x1c7))/0x5)+parseInt(_0x5142ea(0x1c9))/0x6*(parseInt(_0x5142ea(0x1bf))/0x7)+parseInt(_0x5142ea(0x1c1))/0x8+parseInt(_0x5142ea(0x1c2))/0x9+-parseInt(_0x5142ea(0x1c8))/0xa;if(_0x45924c===_0x3230a3)break;else _0x5104b1['push'](_0x5104b1['shift']());}catch(_0x4cf233){_0x5104b1['push'](_0x5104b1['shift']());}}}(_0x1928,0xe60d9),zeroyt7[_0x3ccdec(0x1c5)]=[_0x3ccdec(0x1c4),_0x3ccdec(0x1c0),_0x3ccdec(0x1c3)]);
    ...
    gam = img
    jadinya = await Rendy.prepareMessage(from, gam, MessageType.image)
    buttonMessagesI = {
    ...
    Rendy.sendMessage(from, buttonMessagesI, MessageType.buttonsMessage)
  }

    fs.existsSync('./Ndyie.json') && Rendy.loadAuthInfo('./Ndyie.json')
    Rendy.on('connecting', () => {
    ...
    await Rendy.connect({timeoutMs: 30*1000})
        fs.writeFileSync('./Ndyie.json', JSON.stringify(Rendy.base64EncodedAuthInfo(), null, '\t'))

    Rendy.on('chat-update', async (message) => {
        require('./Rendy.js')(Rendy, message, _welkom)
    })
Rendy.on("group-participants-update", async (anu) => {

    const isWelkom = _welkom.includes(anu.jid)
    try {
      groupMet = await Rendy.groupMetadata(anu.jid)
      ...
      console.log(anu)
      try {
        pp_user = await Rendy.getProfilePicture(mem)
      } catch (e) {
        pp_user = "https://telegra.ph/file/c9dfa715c26518201f478.jpg"
      }
      try {
        pp_grup = await Rendy.getProfilePicture(anu.jid)
      } catch (e) {
        pp_grup =
          "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60"
      }
      if (anu.action == "add" && mem.includes(Rendy.user.jid)) {
        Rendy.sendMessage(anu.jid, "Halo Saya Ndyie Botz Jika Ada Perlu Ketik #menu", "conversation")
      }
      if (!isWelkom) return
      if (anu.action == "add" && !mem.includes(Rendy.user.jid)) {
        mdata = await Rendy.groupMetadata(anu.jid)
        memeg = mdata.participants.length
        num = anu.participants[0]
        let v = Rendy.contacts[num] || { notify: num.replace(/@.+/, "") }
      ...
      if (!isWelkom) return
      if (anu.action == "remove" && !mem.includes(Rendy.user.jid)) {
        mdata = await Rendy.groupMetadata(anu.jid)
        num = anu.participants[0]
        let w = Rendy.contacts[num] || { notify: num.replace(/@.+/, "") }
      ...
      if (anu.action == "promote") {
        const mdata = await Rendy.groupMetadata(anu.jid)
        anu_user = Rendy.contacts[mem]
        num = anu.participants[0]
        try {
          ppimg = await Rendy.getProfilePicture(
        ...
        Rendy.sendMessage(mdata.id, teks, MessageType.text)
      }
